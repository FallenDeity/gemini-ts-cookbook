...
**For comprehensive API documentation, visit [ai.google.dev](https://ai.google.dev/gemini-api/docs#javascript).**

## Navigating the Cookbook

This cookbook is organized into two main categories:

1.  **[Quick Starts](https://github.com/FallenDeity/deepmind-starter/tree/main/quickstarts):**  Step-by-step guides covering both introductory topics ("[Get Started](./quickstarts/Get_started.ipynb)") and specific API features.
2.  **[Examples](https://github.com/FallenDeity/deepmind-starter/tree/main/examples):** Practical use cases demonstrating how to combine multiple features.
...
The [quickstarts section](https://github.com/FallenDeity/deepmind-starter/tree/main/quickstarts) contains step-by-step tutorials to get you started with Gemini and learn about its specific features.
...
-  And [many more](https://github.com/FallenDeity/deepmind-starter/tree/main/quickstarts)
...
-  And [many many more](https://github.com/FallenDeity/deepmind-starter/tree/main/examples)
...
The Gemini API is a REST API. You can call it directly using tools like `curl` (see [REST examples](https://github.com/FallenDeity/deepmind-starter/tree/main/quickstarts/rest/) or the great [Postman workspace](https://www.postman.com/ai-on-postman/google-gemini-apis/overview)), or use one of our official SDKs:
...
With Gemini 2 we are offering a [new SDK](https://github.com/googleapis/js-genai)
(<code>[@google/genai](https://www.npmjs.com/package/@google/genai)</code>,
...
improved tool usage (
[code execution](https://ai.google.dev/gemini-api/docs/code-execution?lang=javascript),
[function calling](https://ai.google.dev/gemini-api/docs/function-calling/tutorial?lang=javascript) and integrated
[Google search grounding](https://ai.google.dev/gemini-api/docs/grounding?lang=javascript)),
...
The <code>[generative-ai-js](https://www.npmjs.com/package/@google/generative-ai)</code>
